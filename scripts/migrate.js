...
async function runMigration() {
  ...
  try {
    ...
    `;
    console.log('✔ "unit_conversions" table initialized');
    ...
    if (existingUsers[0].count === 0) {
      ...
      `;
      console.log('✔ Seeded test admin & seller accounts');
    } else {
      console.log('ℹ Users already exist, skipping seeding');
    }

    // 5.5 Seed default units
    ...
    if (existingUnits[0].count === 0) {
      ...
      console.log('ℹ Unit conversions already exist, skipping seeding');
    }
    ...
    if (existingProducts[0].count === 0) {
      ...
      console.log('ℹ Products already exist, skipping seeding');
    }
